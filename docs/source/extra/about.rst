...
.. image:: /gifs/draw_min.gif

.. note::
 We offer Markup and Measurement tools
...
.. image:: /gifs/render_min.gif

.. note::
 Images of up to 4K can be saved.
...
.. image:: /advanced/images/lh_3.jpg

.. note::
 Keep LUX Walker changes and :ref:`Reload a new Model<Merge Tab>`

 This allows you to Merge data from an old file using LUX Home.

Share a File
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. image:: /gifs/multiuser_alt_min.gif
