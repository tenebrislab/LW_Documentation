...
Step 1:  `Download the Latest Rhino plugin from here  <https://tenebrislab.com/wp-content/uploads/LWPlugins/Rhino/Export%20To%20LUX%20Walker.rhi>`_.
Double click the downloaded file (Export To LUX Walker.rhi) to install the Plugin to export to LUX Walker.

Step 2: Run the command LUXWALKER in Rhino.
